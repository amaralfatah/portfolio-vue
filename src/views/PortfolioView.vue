      ...
      items: [
        {
          ...
          imageUrl: 'vue-portfolio',
          status: 'My personal website, I created this website to display my profile, skills and projects. As well as my place to try new technology.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/amaralfatah',
          demo: 'null'
        },
        {
          id: 2,
          ...
          status: 'Hindari membeli buah & sayur busuk! FreshCheck App menggunakan AI untuk menilai kesegaran bahan makanan Anda secara instan.',
          tech: 'Kotlin, XML',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          status: 'Lakukan manajemen inventaris toko baju Anda dengan Dexshop App. Hemat waktu, optimalkan stok, pengingat pesanan dan tingkatkan penjualan dengan solusi yang inovatif dan mudah digunakan.',
          tech: 'Kotlin, XML',
          github: 'null',
          demo: 'null'
        },
        ...
        },
        {
          ...
          status: 'Sistem inklusi Aisyiyah adalah website yang digunakan untuk melaporkan data inklusi yang ada di Aisyiyah seluruh Indonesia.',
        ...
        },
        {
          ...
          status: 'Helpdesk BSI adalah website yang digunakan untuk mencatat keluhan dan permintaan bantuan dari mahasiswa.',
          tech: 'Codeigniter 3, Bootstrap',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          status: 'Posyandu Melati adalah sebuah website yang digunakan untuk memindahkan proses pelaporan posyandu ke platform online, sekaligus melakukan analisis data dan menghasilkan Kartu Menuju Sehat sebagai output.',
