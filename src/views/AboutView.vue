    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Kotlin',
          imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Kotlin_Icon.png/1200px-Kotlin_Icon.png',
          status: 'Advance'
        },
        {
          id: 7,
        ...
        },
        {
          id: 9,
          name: 'Codeigniter',
          imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-codeigniter-logo-icon-download-in-svg-png-gif-file-formats--wordmark-programming-langugae-language-pack-logos-icons-1175201.png?f=webp&w=256',
          status: 'Intermediate'
        },
        {
          id: 9,
...
<template>
  <div
    class="bg-[#1e1e1f] px-5 py-5 md:px-12 md:py-10 text-left border border-[#383838] rounded-3xl text-white mx-3 mb-5">
    <article data-page="about">

      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          About Me &nbsp;
          <div class="h-[1px] w-32 bg-[#90E0EF] md:w-96 aos-init aos-animate" data-aos="zoom-in-left"
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Amar Al Fatah. I'm a fullstack developer from Pangandaran, West Java. I
            have 1 year of experience in mobile and web development.
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-white mx-3">
    <article data-page="about">
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          <div class="h-[1px] w-10 bg-[#90E0EF] md:w-20 aos-init aos-animate" data-aos="zoom-in-left"
            data-aos-duration="600"></div>
          &nbsp; Skills
        </div>
      </header>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-[#90E0EF] bg-[#90E0EF] bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-[#90E0EF] bg-[#90E0EF] bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Tools</button>
            </li>
          </ul>
        </div>
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-[#90E0EF] px-2 py-2 hover:bg-[#90E0EF] hover:bg-opacity-10 md:gap-3 lg:px-3">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-[#90E0EF] transition-all duration-300 md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                </div>
              </div>
            </div>
